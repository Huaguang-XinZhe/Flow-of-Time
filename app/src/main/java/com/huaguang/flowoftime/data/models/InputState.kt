...
data class InputState(
    val eventId: MutableState<Long>, // 输入框的弹出状态，是弹出还是隐藏？
    val show: MutableState<Boolean>, // 事件的新名称
    val newName: MutableState<String>, // 输入框弹出的意图，是要修改还是要记录新事件？
    val intent: MutableState<InputIntent>, // 影响的事件的 id
